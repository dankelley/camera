...
misfit <- function(p)
{
    ...
    vVec <<- c(vVec, p[4])
    p <- proj(gcp$i, gcp$j, elevation=p[1], altitude=p[2], azimuth=p[3], fov=p[4])
...
## bottomleft: solution, with coastline
...
## bottomright: solution, in metres
